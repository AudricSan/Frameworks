    ...
    @foreach ($sellers as $seller)
        <body style="width :100%">
            ...
            <tr>
                ...
                <th style="border: 1px solid black;text-align: center; padding:15px 15px 0 15px"> <h3> {{ $seller->Seller_Name }} </h3> </th>
            </tr>
            <tr>
                <th style="border: 1px solid black; padding:15px 15px 0 15px"> <h3> Prénom : </h3> </th>
                <th style="border: 1px solid black;text-align: center; padding:15px 15px 0 15px"> <h3> {{ $seller->Seller_Surname }} </h3> </th>
            </tr> 
                <th style="border: 1px solid black; padding:15px 15px 0 15px"> <h3> Age :</h3> </th>
                <th style="border: 1px solid black;text-align: center; padding:15px 15px 0 15px"> <h3> {{ $seller->Seller_Ages }} </h3> </th>
            </tr>
