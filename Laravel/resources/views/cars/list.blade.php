    ...
    @foreach ($cars as $car)
        <body style="width :100%">
            ...
            <tr>
                ...
                <th style="border: 1px solid black;text-align: center; padding:15px 15px 0 15px"> <h3> {{ $car->Car_Serial }} </h3> </th>
            </tr>
            <tr>
                <th style="border: 1px solid black; padding:15px 15px 0 15px"> <h3> Puissance : </h3> </th>
                <th style="border: 1px solid black;text-align: center; padding:15px 15px 0 15px"> <h3> {{ $car->Car_Power }} </h3> </th>
            </tr> 
                <th style="border: 1px solid black; padding:15px 15px 0 15px"> <h3> Couleur :</h3> </th>
                <th style="border: 1px solid black;text-align: center; padding:15px 15px 0 15px"> <h3> {{ $car->Car_Color }} </h3> </th>
            </tr>
